...
Drop any skill into Claude's context and it instantly gains domain expertise — sharper output, less back-and-forth, no generic AI slop.

---

## What's a Claude Skill?

A skill is a markdown file that loads expert-level behavior into Claude. Think of it as a system prompt written by a specialist, not a generic assistant.
...
1. Open any skill file and copy its full content
2. Go to [Claude Settings → Custom Instructions](https://claude.ai/settings)
3. Paste it in. Done — every new chat now has the skill active.
...
| Skill | What it does |
|-------|-------------|
| [youtube-downloader](skills/tools/youtube-downloader.md) | Download YouTube videos at any quality and format via bash |

---

## Why Use Skills Instead of Just Prompting?

Good prompts help. Skills change the baseline.
